package com.venndingal.edetour._General;
...
public class Config {
    ...
    public static final String URL_ADD="http://api.venndingal.com/edetour/addUsers.php";
    public static final String URL_GET_ALL = "http://api.venndingal.com/edetour/getAllUsers.php";
    public static final String URL_GET_USER_INFO = "http://api.venndingal.com/edetour/getUserInfo.php?Username=";
